...
class NetWeightRangeSlider extends React.Component {
    constructor(props) {
        ...
        let filter = this.props.data ? this.props.data : undefined
        this.state = {
            values: [filter.net_weight[0].min_net_weight,filter.net_weight[0].max_net_weight]
                ...
                {data ?
                    <View style={{ marginLeft: 10 }}>
                        ...
                        <View
                            ...
                            {values && <Text style={{ fontSize: 16 }}>{parseFloat(this.state.values[0])}</Text>}
                            {values && <Text style={{ fontSize: 16 }}>{parseFloat(this.state.values[1])}</Text>}
                        </View>
                    </View> : null}
            </View>
        );
